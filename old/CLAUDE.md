...
## Capas del método certificado (experimentos/E0-E3, metodo/)
El núcleo se rellena por capas 0-3 en orden de verificabilidad. No existe capa 4.
...
pesos preentrenados ni aprendizaje de datos externos en esta parte.

**Actualizado 2026-09-24**: ya no rige la prohibición absoluta de priors
generativos aprendidos en todo el repo. `upscale/` incorpora un pipeline
con modelos generativos preentrenados (Real-ESRGAN, GFPGAN, CodeFormer —
ver `upscale/upscale.md`) para mejora de fotos, separado de
`experimentos/` y `metodo/`. Las capas 0-3 de arriba y las puertas E0-E3
de abajo siguen describiendo únicamente el Método de Recuperación
Certificada; no aplican a `upscale/`.
